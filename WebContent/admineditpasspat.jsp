                    ...
                    <div class="row  no-margin-bottom">
                    	<div class="col-xs-12">
                            ...
                            <div class="card-header">
								...
								<form action="admineditpasspat">
								Enter the old password <input type="password" name="opass" class="form-control" style="height:30px;width:200px" required><br>
								Enter the new password <input type="password" name="npass" class="form-control" style="height:30px;width:200px" required><br><br>
