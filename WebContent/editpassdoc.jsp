                    ...
                    <div class="row  no-margin-bottom">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Doctor Password Change</div>
                                    </div>
                                </div>
                                <div class="card-body">
                            
                                   	<form action="editpassdoc">
									Enter the old password <input type="text" name="opass" class="form-control" style="height:30px;width:200px" required><br>
									Enter the new password <input type="text" name="npass" class="form-control" style="height:30px;width:200px" required><br>
