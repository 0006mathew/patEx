                ...
                <div class="side-body padding-top">
                    <div class="row  no-margin-bottom">
                                ...
                                <% Connection conn=connection.getconnect();	
                    				try{
    	    							PreparedStatement pst =  conn.prepareStatement("select apptid,reqbegtime,apptdate,reason,description,docid from appt where username=? and c='c' order by apptdate,reqbegtime");
