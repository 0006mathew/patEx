...
<body class="flat-blue">
    <div class="app-container">
     ...
     function sub1()
     {
         ...
         var r=confirm("Confirm the doctor details entered\nUser name: "+i+"\nFirst Name: "+j+"\nLast Name: "+k+"\nEmail: "+l+"\nPhone number: "+m+"\nDate Of Birth: "+p+"-"+mm+"-"+yy);
         return r;
    }
     function available(){
    	 var i=document.getElementById('u').value;
...
<form name="formname" action=createdoc method=post enctype="multipart/form-data" onsubmit="return sub1();">

<table width="100%">
                                  <tr>
                                  <td>User Name</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="u" id="u" class="form-control" style="height:30px;width:200px" onblur="return available();"required></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="button" value="Check Availability" onclick="return available();"></td><td>&nbsp;&nbsp;&nbsp;&nbsp;<span id="err"> </span></td><!-- <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="file" name="photo" size="50"/></td> -->
                                  </tr>                                  
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>First Name </td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="fn" id="fn" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Last Name</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="ln" id="ln" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Specialization</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="sp" id="sp" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Email id</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="email" id="email" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Phone no</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" name="ph" id="ph" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Date of birth</td>
								...
								<select name="yy" id="yy" class="form-control" style="height:30px;width:60px">
                                  ...
                                  <tr>
                                  <td>Password</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="password" name="pass" id="pass" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
                                  
                                  <tr><td><br></td></tr>
                                  <tr>
                                  <td>Re-enter your password</td>
                                  <td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="password" name="pass" id="pass1" class="form-control" style="height:30px;width:200px" required></td>
                                  </tr>
        </table>
<br>
<input type="submit" value="Submit" name="submit" class="btn btn-primary">
<input type="reset" value="Reset" name="submit" class="btn btn-primary">
</form>
                                </div>
                            </div>
                        </div>
