        ...
        <div class="row content-container">
            ...
            <div class="container-fluid">
                <div class="side-body padding-top">
                    ...
                    try{
    	    			PreparedStatement pst =  conn.prepareStatement("select distinct patinfo.username,fname,lname,dob,sex,phno,emailid,addr from patinfo,docpat where patinfo.username=docpat.patid and docpat.docid='"+user+"'");
                                            ...
                                            <table class="table table-bordered" width="100%">
												...
												%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href='#' onclick='javascript:window.open("http://www.google.com", "_blank", "scrollbars=1,resizable=1,height=200,width=300");' title='Pop Up'><%= rs.getString("username") %></a>
                                                        </td>
                                                        <td><%= rs.getString("fname") %><%out.print(" ");%><%= rs.getString("lname") %></td>
