...
<%
	patient d=(patient)session.getAttribute("object");
                                    ...
                                    <ul class="message-list">
                                     <table class="table table-bordered" width="100%">
    									...
    									for (int i=0; i <itemsArray.size();) {
      									...
      									%>
                                        <form name=formname action=patmsgdelete method=post>
                                        <tr>
                                        <td><% out.println(itemsArray.get(i++)); %></td> <td><% out.println(itemsArray.get(i++)); %></td>
                                                    <td><% out.println(itemsArray.get(i++)); %></td>
                                                	<%String e=(String)itemsArray.get(i++);%>
                                            	<input type="hidden" name="msgid" value=<%=e%>>
                                            	<td><input type="submit" name="bt" value="Delete" class="pull-left"/></td>
                                                  </form>
