    ...
    ArrayList itemsArray = (ArrayList) request.getAttribute("items");%>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td>Email</td>
						<td><input name="email" type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td>Phone number</td>
