                ...
                <div class="side-body padding-top">
                    <div class="row  no-margin-bottom">
                    	...
                    	<div class="card">
                         	...
                         	<form action="editpasspat">
							Enter the old password <input type="text" name="opass" class="form-control" style="height:30px;width:200px" required>
							Enter the new password <input type="text" name="npass" class="form-control" style="height:30px;width:200px" required>
