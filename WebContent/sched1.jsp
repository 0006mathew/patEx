...
<body class="flat-blue">
                    ...
                    <div class="row  no-margin-bottom">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Choose the date</div>
                                    </div>
                                </div>
                                <div class="card-body">
    ...
    <th>Check</th>
    <th>Slot Begin time</th>
    <th>Slot End time</th>
   <button id="check_all" class="btn btn-default">Check all</button>
   &nbsp;&nbsp;
   <button id="uncheck_all" class="btn btn-default">Uncheck all</button>
   <form name=selecting action=sched3 method=post>
	<%   if (request.getAttribute("alist") != null) {

    	 ArrayList itemsArray = (ArrayList)request.getAttribute("alist");
     
    	 for (int i=0; i <itemsArray.size(); ) {
      	%>
      
     	 <TR>  
     	 			<td><input type="checkbox" name="check" value=<%=itemsArray.get(i++)%>></td>
   ...
   <br>
   <input type="submit" name="bt" value="Submit" class="btn btn-primary" onclick="myFunction()"/>
   </form>
