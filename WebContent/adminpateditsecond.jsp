                                ...
                                <div id="dropdown-pat" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li><a href="#">Edit Patient Profile</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    ArrayList itemsArray = (ArrayList) request.getAttribute("items");%>
			...
			<table width="100%">
				<tbody>
					...
					<tr>
						<td>First Name:</td>
						<td><input name="fn" type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td>Last Name:</td>
						<td><input name="ln" type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td>Date Of Birth:</td>
						<td><input name="dob" type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td>Sex:</td>
						<td><input name="sex"type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td>Phone number:</td>
						<td><input name="ph" type="text" value=<% out.println(itemsArray.get(i++));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
					<tr>
						<td><br></td>
					</tr>
					<tr>
						<td>Address:</td>
						<td><input name="ad" type="text" style="height:40px;width:200px" value=<% out.println(itemsArray.get(i));%> class="form-control" style="height:30px;width:200px" required></td>
					</tr>
