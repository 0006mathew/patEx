                    ...
                    <div class="row  no-margin-bottom">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Cancel Appointment</div>
                                    </div>
                                </div>
                                <div class="card-body">
                            <form name="cancel" method="post" onsubmit="return sub1();" action="cancelsecond" >
                            <% String a=null; %>
                                            <table class="table table-bordered" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <!--  <th>Doctor's name</th>-->
                                                        <th>Do you want to cancel the appointment?</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                 <% 
                                                 	if (request.getAttribute("array") != null) {
                                                 		int i;
														ArrayList itemsArray = (ArrayList)request.getAttribute("array");
    													for (i=0; i<itemsArray.size();i++) {
    														%>
 
												    <tr> 
             											<%a=(String)itemsArray.get(i++);%>
    											...
    											<td colspan="5" align="center">
    												<input type="text" name="reas" placeholder="Please specify a reason for cancellation" class="form-control" style="height:30px;width:400px" required/>
    											</td>
    											</tr>
    					</form>
    											<%
