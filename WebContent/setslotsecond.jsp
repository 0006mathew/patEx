                    	...
                    	<div class="col-xs-12">
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  <form name="setslot" action="setslotsecond" >
  <h3>Select the days in which the clinic will be closed</h3>    
  <%   if (request.getAttribute("availableItems") != null) {

    ArrayList itemsArray = (ArrayList) request.getAttribute("availableItems");
    ...
    for (int i=0; i <itemsArray.size(); i++) {
      ...
      %>
             ...
             <br>
             <input type="checkbox" name="days" value=<%=itemsArray.get(i)%>>
              <% out.println(itemsArray.get(i)); %>   
      <%  
