                ...
                <div class="side-body padding-top">
                    <div class="row  no-margin-bottom">
                    	<div class="col-xs-12">
                            <div class="card">
                                <div class="card-body">
                                  		<center><a href="#"><i class="fa fa-heartbeat fa-5x"></i></a>
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		<a href="createdoc.jsp"><i class="fa fa-user-md fa-5x"></i></a>
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		<a href="createpat.jsp"><i class="fa fa-users fa-5x"></i></a>
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		<a href="bookadmin.jsp"><i class="fa fa-table fa-5x"></i></a>
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		<a href="viewpatpro.jsp"><i class="fa fa-user fa-5x"></i></a>
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		&nbsp;
                                  		<a href="setslots.jsp"><i class="fa fa-calendar-o fa-5x"></i></a>
                                  		</center>
                                </div>
                            </div>
                        </div>
