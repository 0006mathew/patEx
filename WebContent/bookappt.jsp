                                    ...
                                    <div class="step">
                                        <ul class="nav nav-tabs nav-justified" role="tablist">
                                            ...
                                            <li role="step" class="active">
                                                <a href="" role="tab" id="step2-tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="step2" aria-labelledby="home-tab">
                                                <center>
                                                <% out.println("Doctor: "+session.getAttribute("docname"));%>
                                                <form name="book" action="book" method="post" autocomplete="off">
												<input id="datepicker" name="day" class="form-control" required style="height:30px;width:200px"/>
												<br> <br>
												<input type="submit" value="Check for available slots" class="btn btn-default" />
												</form>
												</center>
											</div>
                                        </div>
