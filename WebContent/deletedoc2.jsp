...
<body class="flat-blue">
                    	...
                    	<div class="col-xs-12">
                            ...
                            <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Delete Doctor</div>
                                    </div>
                                </div>
   ...
   <script type="text/javascript">
     function sub1()
     {
         ...
         var r=confirm("Are you sure that you wish to delete this doctor?");
         return r;
    }
   </script> 
  <h3>The doctor has the following appointments</h3> 
...
<%   if (session.getAttribute("items") != null) {
     ...
     ArrayList itemsArray = (ArrayList) session.getAttribute("items");
     
     %>
      <TR>  <form name=formname action=deletedoctwo method=post onsubmit="return sub1();">
    ...
    %><TD> <input type="submit" name="bt" value="Delete"/> </TD>
