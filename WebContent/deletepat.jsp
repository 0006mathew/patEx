...
<body class="flat-blue">
    <div class="app-container">
     ...
     function sub1()
     {
         ...
         var r=confirm("Are you sure that you wish to delete the patient");
         return r;
    }
   </script>                              
...
<%   if (request.getAttribute("items") != null) {
     ...
     for (int i=0; i <itemsArray.size(); i++) {
      ...
      <TR>  <form name=formname action=deletepatsecond method=post onsubmit="return sub1();">
