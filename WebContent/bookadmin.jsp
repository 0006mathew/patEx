                    	...
                    	<div class="col-xs-12">
                            ...
                            <div class="card-header">
                                    <div class="card-title">
                                        <div class="title">Admin booking</div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
										...
										<form action="bookadmin" method="get">
       Enter the patient id <input name="id" type="text" class="form-control" style="height:30px;width:200px">
       <br><br>
