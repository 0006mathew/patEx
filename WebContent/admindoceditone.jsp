                                ...
                                <div id="dropdown-doc" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li><a href="#">Edit Doctor Profile</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="row  no-margin-bottom">
                    	<div class="col-xs-12">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
							<form action="admineditdocone">
       							 Enter the doctor id <input type="text" name="docid" class="form-control" style="height:30px;width:200px" required><br>
